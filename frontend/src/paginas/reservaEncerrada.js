                    ...
                    <ScrollView>
                        {tableData.map((Reserva, index) => {
                            return <View style={styles.heading} key={Reserva._id}>
                                ...
                                <Text style={styles.Xheading}>Hora Inicial:{Reserva.horaInicio}</Text>
                                <Text style={styles.Xheading}>Hora Final:{Reserva.horaFinal}</Text>
                                <Text style={styles.Xheading}>valor a pagar:{Reserva.valorFinal}</Text>
